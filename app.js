...
app.get('/posts/:postName', function(req, res) {
  const storedTitle = req.params.postName;


  posts.forEach(function(posts_) {
      const requiredTitle = posts_.title;
      const postContent=posts_.post;
...
app.post("/compose", function(req, res) {
  const titleInputbyUser = req.body.titleContent;
  const postInputbyUser = req.body.postContent;
  const composeObject = {
    title: titleInputbyUser,
    post: postInputbyUser
  };
